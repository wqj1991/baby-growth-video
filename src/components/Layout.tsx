      ...
      <aside className="w-64 flex flex-col relative z-10">
        ...
        <div className="relative flex flex-col h-full px-3 py-4">
          ...
          <div className="px-2 pt-3 border-t" style={{ borderColor: '#e8e6de' }}>
            <button
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 text-stone-600 hover:bg-white/60 hover:text-warmth-500"
            >
